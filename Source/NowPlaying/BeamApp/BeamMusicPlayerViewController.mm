...
@property (nonatomic,unsafe_unretained) IBOutlet UISlider* volumeSlider; // Volume Slider
@property (nonatomic,unsafe_unretained) IBOutlet OBSlider* progressSlider; // Progress Slider buried in the Progress View

@property (nonatomic,unsafe_unretained) IBOutlet AutoScrollLabel* trackTitleLabel; // The Title Label
@property (nonatomic,unsafe_unretained) IBOutlet AutoScrollLabel* albumTitleLabel; // Album Label
@property (nonatomic,unsafe_unretained) IBOutlet AutoScrollLabel* artistNameLabel; // Artist Name Label

@property (nonatomic,unsafe_unretained) IBOutlet UIToolbar* controlsToolbar; // Encapsulates the Play, Forward, Rewind buttons

@property (nonatomic, strong) IBOutlet UIBarButtonItem *actionButton; // retain, since controller keeps a reference while it might be detached from view hierarchy
@property (nonatomic, strong) IBOutlet UIBarButtonItem *backButton; // retain, since controller keeps a reference while it might be detached from view hierarchy

@property (nonatomic,unsafe_unretained) IBOutlet UIBarButtonItem* rewindButton; // Previous Track
@property (nonatomic,unsafe_unretained) IBOutlet UIBarButtonItem* fastForwardButton; // Next Track
@property (nonatomic,unsafe_unretained) IBOutlet UIBarButtonItem* playButton; // Play

@property (nonatomic,unsafe_unretained) IBOutlet UIImageView* albumArtImageView; // Album Art Image View
@property (nonatomic,unsafe_unretained) IBOutlet UIImageView* albumArtReflection; // It's reflection
...
@property (nonatomic,unsafe_unretained) IBOutlet UIView* scrobbleOverlay; // Overlay that serves as a container for all components visible only in scrobble-mode
@property (nonatomic,unsafe_unretained) IBOutlet UILabel* timeElapsedLabel; // Elapsed Time Label
@property (nonatomic,unsafe_unretained) IBOutlet UILabel* timeRemainingLabel; // Remaining Time Label
@property (nonatomic,unsafe_unretained) IBOutlet UIButton* shuffleButton; // Shuffle Button
@property (nonatomic,unsafe_unretained) IBOutlet UIButton* repeatButton; // Repeat button
@property (nonatomic,unsafe_unretained) IBOutlet UILabel* scrobbleHelpLabel; // The Scrobble Usage hint Label
@property (nonatomic,unsafe_unretained) IBOutlet UILabel* numberOfTracksLabel; // Track x of y or the scrobble speed
@property (nonatomic,unsafe_unretained) IBOutlet UIImageView* scrobbleHighlightShadow; // It's reflection
...
@property (nonatomic,unsafe_unretained) IBOutlet UINavigationItem* navigationItem;
